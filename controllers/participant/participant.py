...
# Controle em malha fechada baseado nas linhas 86-90
target_position = 2.92  # Defina o valor alvo adequado para o braço

while abs(robot.getArmPosition() - target_position) > 0.01:  # Ajuste a condição de acordo com o seu sensor
    error = target_position - robot.getArmPosition()
    control_signal = kp * error + ki * integral_error  # Ajuste kp e ki conforme necessário
    robot.setArmVelocity(control_signal)
